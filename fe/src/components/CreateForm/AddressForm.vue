<template>
  <div>
    ...
    <small v-if="response.search">
      ...
      {{ response.search.lineTwo }}, district: {{ response.search.district }},
      city: {{ response.search.city }}, post code:
    ...
    <div class="columns is-centered">
      <b-button @click="storeNewAddress()" v-if="validAddress" type="primary"
