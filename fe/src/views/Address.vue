  ...
  <div>
    <div :class="['sticky', { shadow: isShadow }]">
      <div class="subtitle has-text-centered">
        {{ address.line_one }}, {{ address.line_two }}, {{ address.district }},
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p
              :class="[
                'title',
                { 'has-text-danger': address.average.ratings.overall <= 2 },
                { 'has-text-success': address.average.ratings.overall >= 4 },
              ]"
            >
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p
              :class="[
                'title',
                { 'has-text-danger': address.average.ratings.landlord <= 2 },
                { 'has-text-success': address.average.ratings.landlord >= 4 },
              ]"
            >
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p
              :class="[
                'title',
                { 'has-text-danger': address.average.ratings.premise <= 2 },
                { 'has-text-success': address.average.ratings.premise >= 4 },
              ]"
            >
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p
              :class="[
                'title',
                { 'has-text-danger': address.average.ratings.area <= 2 },
                { 'has-text-success': address.average.ratings.area >= 4 },
              ]"
            >
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p
              :class="[
                'title',
                { 'has-text-danger': address.average.ratings.transport <= 2 },
                { 'has-text-success': address.average.ratings.transport >= 4 },
              ]"
            >
        ...
        <div class="level-item has-text-centered">
          <div>
            ...
            <p
              :class="[
                'title',
                { 'has-text-danger': address.average.ratings.noise <= 2 },
                { 'has-text-success': address.average.ratings.noise >= 4 },
              ]"
            >
